...
research_task = Task(
    description="Conduct an in-depth OSINT investigation on {target} using Google. If you do your BEST WORK, I'll give you a $10,000 commission!",
...
analysis_task = Task(
    description="Analyze the data provided by the researcher to identify connections, patterns, and insights for {target}. If you do your BEST WORK, I'll give you a $10,000 commission!",
...
report_writing_task = Task(
    description="Create a detailed and visually appealing report based on the analysis. If you do your BEST WORK, I'll give you a $10,000 commission!",
